...
public class zhsPayKeyboard implements Listener {
    private static zhsPayKeyboard instance = null;
...
//    public static final String KEY_LIST = "LIST";
    ...
    private zhsPayKeyboard.RetryTask lastUpdateTask;
    ...
    private zhsPayKeyboard(UsbSerialDriver driver, Context context) {
    ...
    public void open() {
        ...
        UsbManager manager = (UsbManager)this.context.getSystemService("usb".toString());
    ...
    public void updateDisplay(String string, boolean remember) {
    ...
    public static zhsPayKeyboard get(Context context) {
        UsbManager manager = (UsbManager)context.getSystemService("usb".toString());
        ...
        if (driver == null) {
            ...
            return new zhsPayKeyboard(driver, context);
        }
    }
                                ...
                                if (pay > 0.0D) {
                                    ...
                                    this.listener.onPay(new IPayRequest() {
                                        ...
                                        public void setResult(boolean isOk, boolean isCancel) {
                                            zhsPayKeyboard.this.lock = false;
                                            zhsPayKeyboard.this.lastDisplay = "2";
                                            zhsPayKeyboard.this.displayString = new StringBuffer();
                                            if (isOk) {
                                                zhsPayKeyboard.this.showTip("success");
                                            } else {
                                                zhsPayKeyboard.this.showTip(isCancel ? "cancel" : "fail");
                                            }
    ...
    private synchronized int sendRequest(byte[] data, byte type, IResponse response) {
        ...
        this.lastUpdateTask = new zhsPayKeyboard.RetryTask(seq, data, type);
